...
def logo():
    ...
    print '\x1b[1;91m __ ABDUL-TUAN    ____ ___\n\x1b[1;91m| ABDUL-TUAN _ \_ _|\n\x1b[1;92m| ABDUL TUAN | |\n\x1b[1;92m| TUAN | |\n\x1b[1;91m|_TUAN_|\n\x1b[1;91m\n\x1b[1;97m-------------------------------------------------'
...
def login():
    os.system('clear')
    try:
        requests.get('https://www.facebook.com/profile.php?id=100008872718745')
    ...
    try:
        ...
        if token == '':
            ...
            if token == 'help':
                os.system('xdg-open https://www.facebook.com/profile.php?id=100008872718745')
